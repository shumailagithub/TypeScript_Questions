...
let nameCase = "Sir Daniyal Nagori"; //camalCase   "second word should be Capital"
...
let my_name = "Shumaila"; //snake_case variable     "hyphen(_) in first and Last name"
console.log(my_name);
//-------------------------------------------------Task # 3-----------------------------------------------------
...
let FreiendName = "Nazish"; //PascalCase         "first and second letter should be Capital"
console.log(FreiendName);
export {};
